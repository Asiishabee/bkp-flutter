class Movie{
  ...
  static List<Movie> getMovies()=>[
    ...
    Movie("Avatar", "2009", "PG-13", "Released:18 Dec 2009", "162 min", "Genre:Action, Adventure, Fantasy",
 "James Cameron",
 "James Cameron",
...
"English, Spanish",
 ...
 "Won 3 Oscars. Another 80 wins & 121 nominations.",
  "http://ia.media-imdb.com/images/M/MV5BMTYwOTEwNjAzMl5BMl5BanBnXkFtZTcwODc5MTUwMw@@._V1_SX300.jpg", "movie",
  "True", [
  ...
  Movie(
     ...
     "Will Smith, Alice, Charlie Tahan, Salli Richardson-W",
...
"PG-13",
   ...
   "Genre:Action, Sci-Fi, Thriller",
     "Joss Whedon",
"Joss Whedon, Zak Penn, Joss Whedon",
"Robert Downey Jr., Chris Evans, Mark Ruffalo",
  ...
  Movie(
   ...
   "Released:07 Nov 2014",
    ...
    "Ellen Burstyn, Matthew Mc, Mackenzie Foy,",
 ...
 "Michael Hirst",
   "Travis Fimmel, Clive Standen, Gustaf Skarsgård, ",
      ...
      "Ireland, Canada",
    "Nominated for 7 Primetime Emmys.other 17 wins& \n 49 nominations.",
...
//  ),
  ...
  Movie(this.title, this.year, this.rated, this.released, this.runtime,
      ...
      this.language, this.country, this.awards, this.poster, this.type,
      this.response, this.images);
